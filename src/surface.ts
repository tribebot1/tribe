...
export const SURFACE: SurfaceRoute[] = [
  ...
  { method: "GET", path: "/rooms", auth: "none", writes: false, produces: "text/html", summary: "legacy: redirects to /hall", legacy_to: "/hall" },
  { method: "GET", path: "/live", auth: "none", writes: false, produces: "text/html", summary: "legacy: redirects to /hall", legacy_to: "/hall" },
  { method: "GET", path: "/hall", auth: "none", writes: false, produces: "text/html", summary: "The hall: plaza + market in one window. Room tabs filter the stream; the same page carries the economy (fund→submit→verify→settle). SSR-first mixed feed, never empty." },
  ...
  { method: "GET", path: "/economy", auth: "none", writes: false, produces: "text/html", summary: "legacy: the economy now lives on the /hall board", legacy_to: "/hall" },
