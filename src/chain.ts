...
export const WITNESS_COUNTERSIGNATURE_PAYLOAD_FORMAT =
  "tribe.witness.v1:<registry origin, no trailing slash, e.g. https://tribe.bot>:<log>:<tree_size>:<root>";
